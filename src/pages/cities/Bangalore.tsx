  ...
  const stats = [
    {
      ...
      description: "Growing coverage in Bangalore"
    },
    {
      icon: Users,
      label: "Delivery Partners",
      description: "Dedicated partner fleet"
    },
    {
      icon: Package,
      label: "Daily Deliveries",
      description: "Consistent delivery success"
    }
  ];

  const areas = [
    "Indiranagar", "Koramangala", "HSR Layout", "Whitefield",
    "JP Nagar", "Marathahalli", "Electronic City", "Bannerghatta",
      ...
      <div className="relative h-[400px]">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-end pb-16">
          <div className="text-white">
            <h1 className="text-4xl font-bold mb-4">Bangalore</h1>
            <p className="text-xl text-teal-300">Expanding pincode coverage</p>
          </div>
        </div>
      </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-gray-600 mb-6">
                Experience the fastest delivery service in Bangalore. Sign up now and transform 
            ...
            <div className="relative">
              ...
              <img 
                src="https://images.unsplash.com/photo-1569950044272-e04b4b26300c?auto=format&fit=crop&w=800&q=80"
                alt="Bangalore Delivery"
